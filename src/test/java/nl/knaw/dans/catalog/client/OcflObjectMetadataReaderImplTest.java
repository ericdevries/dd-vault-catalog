...
class OcflObjectMetadataReaderImplTest {
    ...
    void readMetadata() {
        ...
        var json = "{\"dcterms:modified\":\"2021-11-17\",\"dcterms:creator\":\"DANS Archaeology Data Station (dev)\",\"@type\":\"ore:ResourceMap\",\"@id\":\"https://dar.dans.knaw.nl/datasets/export?exporter=OAI_ORE&persistentId=doi:10.5072/DAR/KXTEQT\",\"ore:describes\":{\"citation:Topic Classification\":{\"topicClassification:Term\":\"Public health\"}}}";
